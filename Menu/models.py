...
class Menu(models.Model):
    class placeMenu(models.TextChoices):
        navar_menu_1 = "MN1", "جایگاه هدر اول"
    ...
    icon_name = models.CharField(max_length=50, blank=True, null=True, verbose_name="نام آیکون")
    icon_color = models.CharField(max_length=50, blank=True, null=True, verbose_name="رنگ ایکون")
